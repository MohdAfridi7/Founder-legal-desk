...
const contactImage = "/contact_hero.png";
const INK = '#1C1D20';
const AMBER = '#E8BF96';
    ...
    >
      ...
      <div className="container relative z-10 mx-auto max-w-[1320px] px-4 pb-20 sm:px-6 sm:pb-24 lg:px-8 lg:pb-28">
        ...
        >
          ...
          >
            Book a consultation, ask a question, or request a quote for a specific document —
          ...
          <motion.div variants={item} className="flex flex-wrap items-center gap-4 sm:gap-6">
            ...
            <HoverSwapButton href="#contact-form" icon={ArrowRight}>
              Send a Message
            </HoverSwapButton>
          </motion.div>
        </motion.div>
