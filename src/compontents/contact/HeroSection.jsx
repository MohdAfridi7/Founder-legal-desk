...
const HERO_BG_IMAGE = "/contact_hero.png";
          ...
          >
            ...
            <motion.div
                     ...
                     >
                       ...
                       <span style={{ color: AMBER }}>Contact</span>
                     </motion.div>
            ...
            >
                <span className="block overflow-hidden">
                  <motion.span
                    ...
                    className="block"
                  >
              Have a Legal Question? Talk to Your Legal Desk.
                  </motion.span>
                </span>
            </h1>
            ...
            >
Whether you need ongoing legal support, have a specific requirement, or simply need guidance on a legal issue, tell us what's going on. We'll help you understand the next step.
            ...
            <motion.div variants={slideLeft} className="flex flex-wrap items-center gap-6">
              <HoverSwapButton href="free-consultation" icon={ArrowUpRight}>
               ...
               <HoverSwapButton href="#contact-form" icon={ArrowUpRight}>
              Send a Message
              </HoverSwapButton>
            </motion.div>
