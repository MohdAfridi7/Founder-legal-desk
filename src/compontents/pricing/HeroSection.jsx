      ...
      <div className="container relative z-10 mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-10 pb-16 lg:grid-cols-2 lg:gap-20 lg:pb-0">
          ...
          >
            ...
            >
                <span className="block overflow-hidden">
                  <motion.span
                    ...
                    className="block"
                  >
                 Your Legal Team. Without the In-House Cost.
                  </motion.span>
                </span>
            </h1>
            ...
            >
  Choose an ongoing legal support plan built around your business needs. Get access to legal guidance, documentation and business support without the cost of maintaining a full-time legal team.
