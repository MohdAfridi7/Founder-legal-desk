...
// Reuse the same hero background as the Home page so the two pages feel like one site.
const HERO_BG_IMAGE = 'https://demos.coderplace.in/wordpress/WP01/WP01007/wp-content/uploads/2022/06/about-parallax.jpg';
...
// Splits the heading into words so each one animates in individually — a bit more
// "advanced" than a single fade, without needing any extra libraries.
    ...
    <h1 className={className} style={style}>
      {words.map((word, i) => (
        <motion.span
          ...
          transition={{ duration: 0.65, ease: 'easeOut', delay: 0.35 + i * 0.06 }}
...
export default function AboutHeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Background image — slow continuous Ken Burns zoom so it never feels static */}
      <motion.div
      ...
      {/* Dark-to-transparent overlay, matching the Home hero */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        style={{
          background:
            'linear-gradient(90deg, rgba(0,0,0,0.95) 6%, rgba(0,0,0,0.0) 42%, rgba(0,0,0,0.0) 100%)',
        }}
      />

      {/* Floating ambient glow — subtle depth, echoes the .blob accents from the reference page */}
      <motion.div
      ...
      <div className="container relative z-10 mx-auto max-w-[1320px] px-4 pb-20 sm:px-6 sm:pb-24 lg:px-8 lg:pb-28">
        ...
        >
          ...
          >
            ...
            <span style={{ color: AMBER }}>About Us</span>
          </motion.div>

          <AnimatedHeading
            text="Document protection shouldn't be a luxury."
          ...
          >
            We built Founders Legal Desk because good businesses were getting hurt by contracts
            they didn&apos;t understand, agreements they never signed, and compliance gaps they
            didn&apos;t know existed.
          </motion.p>
