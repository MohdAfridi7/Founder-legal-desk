...
const HERO_BG_IMAGE = "/pricing_hero.png";
      ...
      <div className="container relative z-10 mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-10 pb-16 lg:grid-cols-2 lg:gap-20 lg:pb-0">
          ...
          >
            ...
            >
                <span className="block overflow-hidden">
                  <motion.span
                    ...
                    className="block"
                  >
                 Every Business Deserves a Legal Team.
                  </motion.span>
                </span>
            </h1>
            ...
            >
  We built Founders Legal Desk to make ongoing legal support accessible to startups and MSMEs. From everyday legal questions to complex business requirements, we give founders a legal desk they can rely on as they build, grow and navigate what comes next.
