      ...
      <div className="container relative z-10 mx-auto max-w-[1320px] px-4 pb-20 sm:px-6 sm:pb-24 lg:px-8 lg:pb-28">
        ...
        >
          ...
          >
            ...
            <span style={{ color: AMBER }}>Free Consultation</span>
          </motion.div>

          <AnimatedHeading
            text="Talk to us before you commit to anything."
          ...
          >
           Book a free 30-minute consultation. We'll review your current document setup, tell you where the gaps are, and recommend what your business actually needs — with no obligation to buy anything.
          </motion.p>
